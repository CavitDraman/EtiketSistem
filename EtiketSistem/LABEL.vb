...
Public Class LabelProject
    ...
    Public Class Label
        ...
        Private List As System.Collections.Specialized.OrderedDictionary
...
#Region "Properties"
        ...
        Public Property PageSetupDlg As New PageSetupDialog
        Public Property PrintDlg As New PrintDialog
...
#End Region
        ...
        Private Sub mPrintDoc_PrintPage(sender As Object, e As PrintPageEventArgs) Handles mPrintDoc.PrintPage
...
#Region " Properties"
        ...
        <TypeConverter(GetType(DataFieldList)),
        CategoryAttribute("Data"),
        DescriptionAttribute("Nesne Data alanı")>
        Public Property DataField As String = ""

        <CategoryAttribute("Data"), Description("Birleştirilecek alanların listesi")>
        ...
        <CategoryAttribute("Çizgi"), Description("Nesne çizgi kalınlığı")>
        ...
        DescriptionAttribute("Barkod veri alanı")>
        Public Property BarkodVeriAlanı As String = ""

        <CategoryAttribute("Resim"), Description("Resim")>
...
#End Region
    ...
    Public Class VeriFieldList
        ...
        Public Overloads Overrides Function GetStandardValues(ByVal context As ITypeDescriptorContext) As TypeConverter.StandardValuesCollection
            ...
            'For Each T As LabelItem In Frm_Main.MyLabel
            '    If T.Type = LabelItem.ItemType.Text Then
            '        MyList.Add(T.Name)
            '    End If
            'Next
